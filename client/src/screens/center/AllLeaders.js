			...
			<ScrollView style={{ flex: 1 }} contentContainerStyle={{ flexGrow: 1 }} showsVerticalScrollIndicator={false}>
				...
				<Animatable.View animation='fadeInDown' duration={1000}>
					...
					>
						...
						>
							All {this.props.navigation.getParam('center')} Centre Leaders
						</Text>
					</Card>
					...
					<Animatable.View animation='fadeInDown' duration={1300}>
						<Card
							containerStyle={{
								...styles.card,
								height: this.isCenterLeader() ? 300 : 500,
							}}
						>
							...
							{this.props.center.leadersData && (
								<FlatList
									style={{ height: this.isCenterLeader() ? 190 : 700 }}
									...
									renderItem={({ item }) => {
										return (
											<TouchableOpacity
												onPress={() =>
													this.props.navigation.navigate('AllLeaderData', {
														data: item,
...
AllLeaders['navigationOptions'] = screenProps => ({
	title: 'All Leaders',
});

export default connect(mapStateToProps, { AddLeadersData })(AllLeaders);
