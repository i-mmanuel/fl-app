...
class ViewLeaderHistoryData extends Component {
	returnLeaderName = id => {
		let name = '';
...
ViewLeaderHistoryData['navigationOptions'] = screenProps => ({
...
export default connect(mapStateToProps, null)(ViewLeaderHistoryData);
