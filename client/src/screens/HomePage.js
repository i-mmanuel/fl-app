				...
				this.props.AddAttendance([
					{
						...
						names_first_timers: '',
						names_of_converts: '',
						number_first_timers: '0',
						number_of_converts: '0',
						started_nbs: '0',
					...
					<>
						<Animatable.View animation='fadeInDown' duration={1000}>
							<Card containerStyle={{ ...styles.card, marginTop: -50 }}>
								...
								<TouchableOpacity
									...
									style={styles.button}
									onPress={() => {
										this.props.navigation.navigate('NewDataForm');
									}}
								>
									<Text style={{ color: 'white' }}>SUBMIT ATTENDANCE DATA</Text>
								</TouchableOpacity>
							</Card>
						</Animatable.View>
						...
						<Animatable.View animation='fadeInDown' delay={100} duration={1200}>
							<Card containerStyle={{ ...styles.smallerCard }}>
								<TouchableOpacity
									onPress={() =>
										this.props.navigation.navigate('EditDataForm', {
								...
								>
									...
									{this.props.attendance.attendanceData ? (
										...
										>
											...
											<AnimatedNumber
												title='FTS'
												number={_.last(this.props.attendance.attendanceData).number_first_timers}
											/>
											<AnimatedNumber
												title='CON'
												number={_.last(this.props.attendance.attendanceData).number_of_converts}
											/>
											<AnimatedNumber title='NBS' number={_.last(this.props.attendance.attendanceData).started_nbs} />
											<AnimatedNumber title='FNBS' number={_.last(this.props.attendance.attendanceData).finished_nbs} />
										</View>
									) : (
										<Text>Loading...</Text>
									)}
						...
						<Animatable.View animation='fadeInDown' delay={200} duration={1400}>
							<TouchableOpacity onPress={() => this.props.navigation.navigate('AllDataView')}>
								<LineChart
									data={{
...
Homepage['navigationOptions'] = screenProps => ({
	title: 'Bacenta',
});
...
export default connect(mapStateToProps, { AddAttendance })(Homepage);
