...
class BishopSontas extends Component {
			...
			<ScrollView showsVerticalScrollIndicator={false}>
				...
				>
					...
					{this.props.center.userDetails
						.filter(
							obj =>
								(obj.membership_type === 'Overseer' && obj.center.includes('Sonta')) || obj.center.includes('Sonta')
						)
						.map(item => (
							<Card
								containerStyle={{
...
BishopSontas['navigationOptions'] = screenProps => ({
	title: 'Sontas',
});
...
export default connect(mapStateToProps, null)(BishopSontas);
