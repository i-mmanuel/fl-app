...
class AllDataView extends Component {
	render() {
		return (
			<ScrollView showsVerticalScrollIndicator={false}>
				...
				<Animatable.View animation='fadeInDown' duration={1000}>
					...
					<Card containerStyle={{ ...styles.card, marginBottom: 20, height: 450 }}>
						<Text
							style={{
								textAlign: 'center',
								borderColor: '#dcdcdc',
						...
						<View style={styles.row}>
							<Text style={{ marginVertical: 10, fontWeight: 'bold' }}>Data</Text>
						...
						<FlatList
							...
							renderItem={({ item }) => {
								return (
									<TouchableOpacity onPress={() => this.props.navigation.navigate('ViewData', { item })}>
										<View style={styles.row}>
...
export default connect(mapStateToProps, null)(AllDataView);
